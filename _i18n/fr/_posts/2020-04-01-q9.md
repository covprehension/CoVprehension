...
Dans ce modèle les individus sont soit non-porteurs (beige), soit porteurs asymptomatiques (marron) lorsqu’ils sont contaminés par contact avec un porteur, puis au bout de 8 jours ils deviennent porteurs symptomatiques (noir) et 14 jours plus tard ils deviennent rémis (bleu turquoise).
...
<br>NB: <i>Dans la réalité les individus asymptomatiques ne sont pas identifiables à moins de les tester. Ils sont figurés en marron pour pouvoir voir leur rôle dans la propagation.</i>
