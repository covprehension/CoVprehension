...
>  NB : ce n’est pas un hasard si dans notre exemple, le réseau se morcelle quand on enlève 80% des liens. En effet, avec 10 liens en moyenne par agent, au delà de 80% un agent, durant le confinement, gardera moins de 2 liens en moyenne. Or en dessous de 2 liens par agent, il devient mathématiquement impossible de créer une chaine de liens connectant tous les agents.


### Gagner du temps ?!

Il devient alors intéressant ici de lever une hypothèse qui est faite depuis le début de cette question et faire en sorte que les personnes infectées guérissent enfin ! En effet si le confinement ralentit la propagation du virus et qu’ainsi le virus finit par progresser moins rapidement que les individus infectés ne guérissent, il peut être stoppé avant de contaminer tout le monde. Dans la suite nous supposerons qu’un agent reste contagieux durant 21 jours ce qui est raisonnable au vu des données sur la maladie (Merci de me confirmer).
...
***Illustration :** probabilité de transmission de la maladie de 5%. Même « smallworld» que dans l'illustration précédente (10 liens par agents) mais avec un confinement qui couperait 70% des liens existants.*
...
(2) DeStefano et al. " Factors Associated with Social Contacts in Four Communities During the 20072008 Influenza Season." (Epidemiology & Infection 139 (8): 1181–90, 2011)
